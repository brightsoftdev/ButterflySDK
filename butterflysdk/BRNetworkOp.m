...
{
	NSLog(@"BR NETWORK OPP - connection didReceiveResponse:");
    if (responseData==nil){
...
- (void)connection:(NSURLConnection *)connection didReceiveData:(NSData *)data
{
	...
	NSLog(@"BR NETWORK OPP - connection didReceiveData: %d", responseData.length);
}

- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	NSLog(@"BR NETWORK OPP - connectionDidFinishLoading");
...
{
	NSLog(@"BR NETWORK OPP - connection didFailWithError: %@", [error localizedDescription]);
    [delegate requestData:nil];
}
