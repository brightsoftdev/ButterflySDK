...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        backgrounds = [[NSArray alloc] initWithObjects:@"bg_button_station.png", @"bg_button_station_news.png", @"bg_button_station_admins.png", @"bg_button_station_garbage.png", nil];
        btnTitles = [[NSDictionary alloc] initWithObjectsAndKeys:@"tracks", @"bg_button_station.png", @"articles", @"bg_button_station_news.png", @"admins", @"bg_button_station_admins.png", @"delete", @"bg_button_station_garbage.png", nil];
...
- (void)setup
{
    ...
    btnTracks.adjustsImageWhenHighlighted = NO;
    ...
    btnNews.adjustsImageWhenHighlighted = NO;
    ...
    btnAdmins.adjustsImageWhenHighlighted = NO;
